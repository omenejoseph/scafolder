...
use OmeneJoseph\Scafolder\Commands\CreateServiceCommand;
...
class ScafolderServiceProvider extends ServiceProvider
{
    ...
    protected function bootForConsole()
    {
        ...
        // Registering package commands.
         $this->commands([CreateRepositoryCommand::class, CreateTraitCommand::class, CreateServiceCommand::class]);
    }
}
